...
func TestReadAll(t *testing.T) {
	...
	t.Run("Valid", func(t *testing.T) {
		...
		t.Run("Wave", func(t *testing.T) {
			...
			riffChunk, err := riffbin.ReadAll(decoder)
			if err != nil {
				t.Fatal(err)
			}
		...
		t.Run("EmptyPayload", func(t *testing.T) {
			t.Parallel()
			riffChunk, err := riffbin.ReadAll(bytes.NewReader([]byte{'R', 'I', 'F', 'F', 0x04, 0x00, 0x00, 0x00, 'A', 'B', 'C', 'D'}))
			if err != nil {
				t.Fatal(err)
			}
		...
		t.Run("EmptyListChunk", func(t *testing.T) {
			t.Parallel()
			riffChunk, err := riffbin.ReadAll(bytes.NewReader([]byte{'R', 'I', 'F', 'F', 0x10, 0x00, 0x00, 0x00, 'A', 'B', 'C', 'D', 'L', 'I', 'S', 'T', 0x04, 0x00, 0x00, 0x00, 'E', 'F', 'G', 'H'}))
			if err != nil {
				t.Fatal(err)
			}
		...
		t.Run("EmptySubChunk", func(t *testing.T) {
			t.Parallel()
			riffChunk, err := riffbin.ReadAll(bytes.NewReader([]byte{'R', 'I', 'F', 'F', 0x0C, 0x00, 0x00, 0x00, 'A', 'B', 'C', 'D', 'E', 'F', 'G', 'H', 0x00, 0x00, 0x00, 0x00}))
			if err != nil {
				t.Fatal(err)
			}
	...
	t.Run("EmptyInput", func(t *testing.T) {
		...
		t.Parallel()
		c, err := riffbin.ReadAll(bytes.NewReader(nil))
	...
	t.Run("InvalidFormat", func(t *testing.T) {
		...
		for _, tt := range []struct {
			...
			t.Run(tt.Name, func(t *testing.T) {
				t.Parallel()
				c, err := riffbin.ReadAll(bytes.NewReader(tt.Bytes))
	...
	t.Run("EmulateIOError", func(t *testing.T) {
		...
		for lim := int64(0); lim < 2044; lim++ {
			const binary = ""
			decoder := base64.NewDecoder(base64.StdEncoding, strings.NewReader(binary))
			_, err := riffbin.ReadAll(io.LimitReader(decoder, lim))
			if lim == 0 {
...
func TestReadSections(t *testing.T) {
	...
	t.Run("Valid", func(t *testing.T) {
		...
		t.Run("Wave", func(t *testing.T) {
			...
			const binary = ""
			decodedBin, err := base64.StdEncoding.DecodeString(binary)
			if err != nil {
				t.Fatal(err)
			}

			riffChunk, err := riffbin.ReadSections(bytes.NewReader(decodedBin))
			if err != nil {
				t.Fatal(err)
			}
			...
			if df := cmp.Diff(riffChunk, expected, cmpopts.IgnoreUnexported(riffbin.SectionSubChunk{}), cmpopts.IgnoreFields(riffbin.SectionSubChunk{}, "SectionReader")); df != "" {
				t.Fatalf("diff = %s", df)
			}

			for i, expectedBytes := range [][]byte{
				{
					0x01, 0x00, // Compression Code (Linear PCM)
					0x01, 0x00, // Number of channels (Monoral)
					0x44, 0xAC, 0x00, 0x00, // Sample rate (44.1Hz)
				...
				{},
			} {
				gotChunk := riffChunk.Payload[i].(*riffbin.SectionSubChunk)
				got, err := io.ReadAll(gotChunk)
				if err != nil {
					t.Fatal(err)
				}

				if df := cmp.Diff(expectedBytes, got); df != "" {
		...
		t.Run("EmptyPayload", func(t *testing.T) {
			...
			riffChunk, err := riffbin.ReadSections(bytes.NewReader([]byte{'R', 'I', 'F', 'F', 0x04, 0x00, 0x00, 0x00, 'A', 'B', 'C', 'D'}))
			if err != nil {
				t.Fatal(err)
			}
		...
		t.Run("EmptyListChunk", func(t *testing.T) {
			...
			riffChunk, err := riffbin.ReadSections(bytes.NewReader([]byte{'R', 'I', 'F', 'F', 0x10, 0x00, 0x00, 0x00, 'A', 'B', 'C', 'D', 'L', 'I', 'S', 'T', 0x04, 0x00, 0x00, 0x00, 'E', 'F', 'G', 'H'}))
			if err != nil {
				t.Fatal(err)
			}
		...
		t.Run("EmptySubChunk", func(t *testing.T) {
			...
			riffChunk, err := riffbin.ReadSections(bytes.NewReader([]byte{'R', 'I', 'F', 'F', 0x0C, 0x00, 0x00, 0x00, 'A', 'B', 'C', 'D', 'E', 'F', 'G', 'H', 0x00, 0x00, 0x00, 0x00}))
			if err != nil {
				t.Fatal(err)
			}
