...
func TestWriter(t *testing.T) {
	...
	t.Run("Basic", func(t *testing.T) {
		...
		n, err := riffbin.NewWriter(&buf).WriteChunk(riffChunk)
		if err != nil {
			t.Fatal(err)
		}
		if n != int64(buf.Len()) {
		...
		t.Run("ReadAll", func(t *testing.T) {
			t.Parallel()
			if got, err := riffbin.ReadAll(&buf); err != nil {
				t.Fatal(err)
	...
	t.Run("UnexpectedStreamingError", func(t *testing.T) {
		t.Parallel()
		n, err := riffbin.NewWriter(io.Discard).WriteChunk(&riffbin.RIFFChunk{
			FormType: [4]byte{'T', 'E', 'S', 'T'},
			Payload: []riffbin.Chunk{
				riffbin.NewStreamingSubChunk([4]byte{'E', 'N', 'T', '1'}, strings.NewReader("sample")),
			},
		})
	...
	t.Run("Complex", func(t *testing.T) {
		...
		var buf bytes.Buffer
		c := crc32.NewIEEE()
		n, err := riffbin.NewWriter(io.MultiWriter(&buf, c)).WriteChunk(riffChunk)
		if err != nil {
			t.Fatal(err)
		}
		if n != int64(buf.Len()) {
	...
	t.Run("EmulateIOError", func(t *testing.T) {
		...
		for lim := int64(0); lim < 2044; lim++ {
			n, err := riffbin.NewWriter(&limitedWriter{N: lim, W: io.Discard}).WriteChunk(&riffbin.RIFFChunk{
				FormType: [4]byte{'W', 'A', 'V', 'E'},
				Payload: []riffbin.Chunk{
					&riffbin.InMemorySubChunk{
						ID: [4]byte{'f', 'm', 't', ' '},
	...
	t.Run("Mixed", func(t *testing.T) {
		...
		n, err := w.WriteChunk(&riffbin.RIFFChunk{
			...
			Payload: []riffbin.Chunk{
				...
				riffbin.NewStreamingSubChunk([4]byte{'E', 'N', 'T', '2'}, strings.NewReader("foo")),
			},
		})
		if err != nil {
			t.Fatal(err)
		...
		n, err := w.WriteChunk(&riffbin.RIFFChunk{
			...
			Payload: []riffbin.Chunk{
				&riffbin.ListChunk{
					ListType: [4]byte{'L', 'S', 'T', '1'},
					Payload: []riffbin.Chunk{
						riffbin.NewStreamingSubChunk([4]byte{'E', 'N', 'T', '1'}, bytes.NewReader([]byte{0x01})),
						&riffbin.ListChunk{
							ListType: [4]byte{'L', 'S', 'T', '2'},
							Payload: []riffbin.Chunk{
								riffbin.NewStreamingSubChunk([4]byte{'E', 'N', 'T', '2'}, bytes.NewReader([]byte{0x01, 0x02})),
								&riffbin.InMemorySubChunk{
									ID:      [4]byte{'E', 'N', 'T', '3'},
									Payload: []byte{0x01, 0x02, 0x03},
								},
				...
				riffbin.NewStreamingSubChunk([4]byte{'E', 'N', 'T', '5'}, bytes.NewReader([]byte{0x01, 0x02, 0x03, 0x04, 0x05})),
				&riffbin.ListChunk{
					ListType: [4]byte{'L', 'S', 'T', '3'},
					Payload:  []riffbin.Chunk{},
				},
				&riffbin.ListChunk{
					ListType: [4]byte{'L', 'S', 'T', '4'},
					Payload: []riffbin.Chunk{
						riffbin.NewStreamingSubChunk([4]byte{'E', 'N', 'T', '6'}, bytes.NewReader([]byte{0x01, 0x02, 0x03, 0x04, 0x05, 0x06})),
					},
				},
			},
		})
	...
	t.Run("Wave", func(t *testing.T) {
		...
		n, err := w.WriteChunk(&riffbin.RIFFChunk{
			...
			Payload: []riffbin.Chunk{
				...
				riffbin.NewStreamingSubChunk([4]byte{'d', 'a', 't', 'a'}, callbackReader(func() func(p []byte) (n int, err error) {
...
func ExampleWriter_WriteChunk() {
	encoder := base64.NewEncoder(base64.StdEncoding, os.Stdout)
	_, err := riffbin.NewWriter(encoder).WriteChunk(&riffbin.RIFFChunk{
		FormType: [4]byte{'W', 'A', 'V', 'E'},
		Payload: []riffbin.Chunk{
			&riffbin.InMemorySubChunk{
				ID: [4]byte{'f', 'm', 't', ' '},
...
func ExampleStreamingWriter_WriteChunk() {
	f, err := os.CreateTemp("", "riffbin")
	if err != nil {
		panic(err)
	}
