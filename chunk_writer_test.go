...
func TestInompletedChunkWriter(t *testing.T) {
	...
	t.Run("Wave", func(t *testing.T) {
		...
		if s := crc32.ChecksumIEEE(got); s != 1646266039 {
			t.Errorf("unexpected check sum: %d", s)
			t.Log(hex.Dump(got))
		}
	})
